...
function start_magazine_scripts() {
	...
	wp_enqueue_style( 'start-magazine-style', get_stylesheet_uri(), array(), '1.0.0' );
	...
	wp_enqueue_script( 'start-magazine-custom', get_template_directory_uri() . '/js/custom' . $min . '.js', array( 'jquery' ), '1.0.0', true );
