...
if ( ! class_exists( 'Start_Magazine_Demo' ) ) {
	 ...
	 * @version 1.0.1
	 */
	class Start_Magazine_Demo {

		/**
		 * Singleton instance of Start_Magazine_Demo.
		 *
		 * @var Start_Magazine_Demo $instance Start_Magazine_Demo instance.
		 */
		...
		/**
		 * Main Start_Magazine_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Start_Magazine_Demo ) ) {
				self::$instance = new Start_Magazine_Demo();
